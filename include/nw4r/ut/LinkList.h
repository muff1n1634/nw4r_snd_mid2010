...
{
	// [SPQE7T]/ISpyD.elf:.debug_info::0x113f65
	...
	namespace detail
	{
		...
		public:
			...
			const typename Iterator::Element *operator ->() const
			{
				return &operator *();
			}
			...
			friend bool operator==(const ReverseIterator &r1,
			                       const ReverseIterator &r2)
			{
		...
		// [SPQE7T]/ISpyD.elf:.debug_info::0x3624de
		namespace dummy { class Iterator {}; } // namespace dummy
	...
	// [SPQE7T]/ISpyD.elf:.debug_info::0x3a151e, 0x3a16c9...
	namespace dummy { template <typename T, int I> class Iterator {}; }

	// [SPQE7T]/ISpyD.elf:.debug_info::0x1150cf, 0x1150eb...
	...
	public:
		...
		typedef class detail::ReverseIterator<ConstIterator>
			ReverseConstIterator;

		// nested classes
	public:
		// [SPQE7T]/ISpyD.elf:.debug_info::0x3a14f4, 0x3a169f...
		...
		private:
			/* base ConstIterator */			// size 0x04, offset 0x00
			LinkListImpl::ConstIterator	it_;	// size 0x04, offset 0x04
		}; // size 0x04
	...
	public:
		...
		// fake (should be direct calls to the LinkListImpl versions)
