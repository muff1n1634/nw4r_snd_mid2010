...
namespace nw4r { namespace snd
{
	...
	public:
		...
		int						biquadFilterType;	// size 0x04, offset 0x1c
		int						priority;			// size 0x04, offset 0x20
		detail::VoiceOutParam	voiceOutParam[4];	// size 0x60, offset 0x24
	}; // size 0x84
...
namespace nw4r { namespace snd { namespace detail
{
	...
	public:
		...
		{
			return ut::Clamp(mPriority + mAmbientParam.priority, 0, 127);
		}
		u32 GetId() const { return mId; }
		PlayerHeap *GetPlayerHeap() { return mPlayerHeap; }
		SoundPlayer *GetSoundPlayer() const { return mSoundPlayer; }
		...
		static int GetAmbientPriority(const AmbientInfo &ambientInfo,
		                              u32 soundId);

	// static members
	public:
		static int const PRIORITY_MAX = 127; // NOTE: dependent name
	...
	private:
		...
		unk4_t				at_0xdc;					// size 0x04, offset 0xdc
	public:
	...
	// friends
	private:
		/* for some reason clang resolves 'friend class SoundHandle;' to
		 * ::nw4r::snd::detail::SoundHandle? is this normal?
		 */
