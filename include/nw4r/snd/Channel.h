...
namespace nw4r { namespace snd { namespace detail
{
	...
	public:
		...
		void SetLfoParam(const LfoParam &param) { mLfo.SetParam(param); }
		...
		bool IsPause() const { return mPauseFlag != false; } // Yeah
		...
		{
			NW4RAssertHeaderClampedLRValue_Line(138, fadeTimes, 0, 0xffff);

			mSilenceVolume.SetTarget(silenceFlag ? 0 : 255, fadeTimes);
		}
	...
	public:
		...
		static int const CHANNEL_MAX;
		static int const CHANNEL_MIN;
	...
	private:
		...
		const WaveInfo				*mWaveInfo;					// size 0x04, offset 0xbc
