...
namespace nw4r { namespace snd { namespace detail
{
	...
	// NOTE: different from ketteiban: no remote fields past remoteFilter
...
namespace nw4r { namespace snd { namespace detail
{
	...
	public:
		...
		void SetMainOutVolume(f32 mainOutVolume) { mPlayerParamSet.mainOutVolume = mainOutVolume; }
		void SetMainSend(f32 mainSend) { mPlayerParamSet.mainSend = mainSend; }
		void SetPanMode(PanMode mode) { mPlayerParamSet.panMode = mode; }
		void SetPanCurve(PanCurve curve) { mPlayerParamSet.panCurve = curve; }
