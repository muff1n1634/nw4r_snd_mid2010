...
#define BUILDSTAMP_MAJOR_REV		STR(__CWCC__)
#define BUILDSTAMP_MINOR_REV		STR(__CWBUILD__)
...
#define BUILDSTAMP_STRING	\
	...
	" (" BUILDSTAMP_MAJOR_REV "_" BUILDSTAMP_MINOR_REV ")" \
	" >>"
...
namespace nw4r { namespace snd
{
	...
	// .sbss
	namespace { static bool sInitialized; }
