...
#include "nw4r/snd/SeqFile.h" // SeqFileReader
...
SeqSound::SeqSound(SoundInstanceManager<SeqSound> *manager, int priority,
	...
	mManager(manager),
	mStartOffset(SeqPlayer::OFFSET_TYPE_TICK),
#else
...
void SeqSound::SeqLoadTask::Execute()
{
	...
	// What (given by ketteiban dwarf)
	struct SeqFile {} const *seq = static_cast<SeqFile const *>(mBuffer);
